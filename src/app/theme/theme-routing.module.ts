...
const routes: Routes = [
    {
        ...
        "children": [
            ...
            {
                path: 'quotes',
                loadChildren: ".\/controller\/quote\/quote.module#QuoteModule"
            },
            // {
            //     path: 'project',
            ...
            {
                path: 'projectNew',
                loadChildren: ".\/controller\/projectNew\/project.module#ProjectModuleNew"
            },
            {
                path: 'employee',
            ...
            {
                path: 'payroll',
                loadChildren: ".\/controller\/payroll\/payroll.module#PayrollModule"
            },
            {
                path: 'timesheet',
                loadChildren: ".\/controller\/employee-timesheet\/employee-timesheet.module#EmployeeTimesheetModule"
            },
            {
                "path": "index",
